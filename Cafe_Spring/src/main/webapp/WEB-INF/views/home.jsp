...
<tr>
   <td style='border:1px solid black;'>
      ...
      <tr><td><select id=selMenu style='width:300px' size=10>
<c:forEach var="menu" items="${ml}">
   ...
   <td style='border:1px solid black;'>
      ...
      <tr><td><select id=selOrder style='width:300px' size=10></select></td></tr>
...
<div style="display:none;" id='dlgSales'>
	...
	<tr>
		<td>
			<select style="width:200px" size=20 id=salesMenu> <!-- 메뉴별호출 -->

	</select>
	</td>
	<td>
	<select style='width:200px' size=20 id=salesMobile></select> <!-- 고객별호출 -->
	</select>
	</td>
	</tr>
</table>
...
.on('click','#btnSummary',function(){
	...
	$('#dlgSales').dialog({
     ...
     open:function(){
       ...
       $.post("/cafe/salesMenu",{},function(txt){ //<- 이 펑션에는 객체로 구성된 어레이가 들었다
    	   $('#salesMenu').empty();
