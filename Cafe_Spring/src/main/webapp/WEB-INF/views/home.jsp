...
<tr>
	<td style='border:1px solid black;'>
		<table>
		<tr style="height:30px;" align=center><td align=center>메뉴목록&nbsp;&nbsp;&nbsp;&nbsp;<button id=btnMenu>메뉴관리</button></td></tr>
...
<tr>
	...
	<td valign=top>
		...
		<table>
		<tr><td>code&nbsp;&nbsp;<input type=text id=code name=d_code size=3></td></tr>
		<tr><td>name&nbsp;<input type=text id=name name=d_name size=10></td></tr>
		<tr><td>price&nbsp;&nbsp;<input type=number id=price name=d_price style='width:100px'></td></tr>
